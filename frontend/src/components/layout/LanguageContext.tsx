...
const translations = {
  en: {
    Dashboard: "Dashboard",
    "Welcome to StockMaster - your inventory management hub": "Welcome to StockMaster - your inventory management hub",
  ...
  hi: {
    Dashboard: "डैशबोर्ड",
    "Welcome to StockMaster - your inventory management hub": "स्टॉकमास्टर में आपका स्वागत है - आपका इन्वेंटरी प्रबंधन केंद्र",
