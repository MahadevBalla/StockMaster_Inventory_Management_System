# StockMaster – Smart Inventory Management
...
- **Secure Authentication**: JWT-based login with OTP verification for enhanced security.
- **Password Management**: Secure password reset flow via email OTP.
